...
function Customer() {
    ...
    function handleClickModal(data) {
        console.log(data);
        console.log(data.salesPerson, User.fullname)
        if (data.salesPerson === User.fullname) {
                    ...
                    <div className='customer__container__content__invoices'>
                        ...
                        <div className='customer__container__content__invoices__table'>
                            <div className='customer__container__content__invoices__table__header'>
                                ...
                                <div className='customer__container__content__invoices__table__header__item' style={{ width: '21vw' }}>Customer's Name</div>
                                <div className='customer__container__content__invoices__table__header__item' style={{ width: '21vw' }}>Company Name</div>
                                ...
                                {finalDataFiltered ? finalDataFiltered.map((item, index) => {
                                    return (
                                        <div className='customer__container__content__invoices__table__row' onClick={() => handleClickModal(item)}>
                                            ...
                                            <div className='customer__container__content__invoices__table__row__item' style={{ width: '21vw' }}>{item.fullname}</div>
                                            <div className='customer__container__content__invoices__table__row__item' style={{ width: '21vw' }}>{item.company}</div>
                                            ...
                                            <div className='customer__container__content__invoices__table__row__item' style={{ width: '9.5vw', textAlign: 'center' }}>{item.customerStatus.toUpperCase()}</div>
